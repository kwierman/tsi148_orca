...
extern ssize_t vme_interrupts_proc_show(struct file *filp,char *buf,size_t count,loff_t *off);
extern ssize_t vme_irq_proc_show(struct file *filp,char *buf,size_t count,loff_t *off);
extern ssize_t vme_window_proc_show(struct file *filp,char *buf,size_t count,loff_t *offp);
